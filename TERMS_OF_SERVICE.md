...
- Use AI-powered trading strategies

---

## 3. REAL MONEY & FINANCIAL RISK WARNING

### ⚠️ CRITICAL RISK DISCLOSURE

**This platform trades with REAL MONEY. You can lose your entire investment.**

- ❌ **NO guaranteed returns** - Past performance ≠ future results
- ❌ **NO guaranteed profits** - Markets are unpredictable
- ❌ **REAL losses** - You own all losses, not the platform
- ❌ **REAL risk** - Black swan events can cause 50%+ losses
- ❌ **NO insurance** - Losses are not protected or insured

**YOU assume 100% of all financial risk.**

### Investment Limits:
- **Start with $1** minimum (test first)
- **Recommended**: Start with paper trading for 2 weeks
- **Risk Management**: Only invest what you can afford to lose
- **Emergency Funds**: Keep 20%+ in cash reserves

---

## 4. USER ELIGIBILITY & REGISTRATION

### 4.1 Age Requirements
- ✅ Must be 18+ years old
- ✅ Must have valid government-issued ID
- ✅ Must be US resident or approved international location

### 4.2 Account Registration
- ✅ Provide truthful, accurate information
- ✅ Maintain confidentiality of login credentials
- ✅ Immediately notify us of unauthorized access
- ❌ No fake accounts or multiple accounts
- ❌ No fraudulent information
- ❌ No prohibited persons (terrorists, sanctioned individuals)

### 4.3 Verification
All users must complete:
1. **Email Verification** - Verify email address
2. **Phone Verification** - Verify phone number
3. **Identity Verification** - Government ID, SSN, address
4. **Financial Verification** - Source of funds documentation
5. **KYC/AML Screening** - Anti-money laundering checks
...
- ❌ Reverse engineering or code copying
- ❌ Creating derivative products
- ❌ Trading on margin with borrowed funds
- ❌ Automated trading without authorization
...
### 6.1 Creator Fee
**$5 flat fee per transaction** (deposit or withdrawal)
...
- 💳 Card Deposits: 2.5-3.5% + $5 creator fee
- 🏦 Bank Transfers: Free + $5 creator fee
- ₿ Crypto: 0.1-0.2% + $5 creator fee
- 📱 PayPal: 2.2% + $5 creator fee

### 6.3 Trading Commissions
**Exchange commissions apply:**
- Stock trades: $0 commission (via Alpaca)
- Crypto trades: 0.1% fee (exchange)
- NFT trades: 2.5% (OpenSea)

### 6.4 Withdrawal Processing
- 🏦 Bank: 1-3 business days + $5 creator fee
- 💳 Card: Instant + 3% fee + $5 creator fee
- ₿ Crypto: 5-30 minutes + 0.2% fee + $5 creator fee
...
### 7.1 Program Details
- **Referral Bonus**: $20 per successful friend referral
- **Friend Bonus**: $20 when friend completes first deposit
- **Unlimited Earnings**: No cap on referral earnings
- **Automatic Processing**: Bonuses paid within 24 hours

### 7.2 Referral Requirements
- Generate unique referral link from dashboard
- Share link with friends
- Friend must sign up and deposit minimum $1
- Bonus credited to your account automatically
- Bonus appears in "Referral Earnings" section

### 7.3 Referral Rules
- ✅ Real people only
- ✅ One bonus per new unique user
- ✅ Cannot refer yourself
- ✅ Cannot artificially create accounts
- ❌ No bot referrals
- ❌ No fraudulent signups
- ❌ No duplicate emails

### 7.4 Bonus Terms
- 💰 $20 bonus paid in USD credit
- 💰 Credited within 24 hours of friend's deposit
- 💰 Can be withdrawn like normal funds
- 💰 Unlimited referrals = unlimited earnings
- ⚠️ Fraudulent referrals result in permanent ban
...
### 8.1 Friends
- ✅ Add friends by email or referral link
- ✅ View friend's portfolio performance (public stats only)
- ✅ See friend's trading activity
- ✅ Compare strategies and results
- ❌ Cannot access friend's personal data
- ❌ Cannot access friend's account

### 8.2 Commenting & Messaging
- ✅ Comment on friend's trades
- ✅ Send direct messages to friends
- ✅ View trade discussions
- ✅ Share trading ideas
...
- No copying or plagiarism of strategies
- Violations result in mute or permanent ban
...
- ✅ FINRA compliant
- ✅ FinCEN reporting
- ✅ State money transmitter licensed
- ✅ AML/KYC compliant
- ✅ GDPR compliant

### 11.2 Tax Responsibility
- **You are responsible** for all tax filings
- Capital gains taxes apply to profits
- Provide 1099 forms annually
- Consult a tax professional
- Platform does not provide tax advice

### 11.3 Legal Authority
- Securities laws apply to stock trading
- Commodities laws apply to crypto trading
- State money transmitter laws apply
- Federal banking regulations apply
- International laws apply to international users
...
1. Submit closure request from account settings
2. Withdraw all remaining funds
3. Account permanently closed after 30 days
4. Data deleted per retention policy

### 12.2 Platform Termination
We may suspend/terminate your account for:
- ❌ Violation of these terms
- ❌ Illegal activity or fraud
- ❌ Money laundering or AML violations
- ❌ Multiple violations of policies
- ❌ Safety or security concerns
- ❌ Regulatory requirement

**Suspended accounts cannot trade or withdraw for 30-60 days pending investigation.**

---

## 13. AMENDMENTS

These Terms of Service may be updated anytime. We will notify users of material changes 30 days in advance. Continued use constitutes acceptance.
...
- **Federal Law**: Securities Act, Commodities Act, DMCA
- **State Law**: California Uniform Code
- **International**: WIPO agreements (where applicable)

**Jurisdiction**: Federal courts in California
