...
(function () {
  ...
  var mount = document.getElementById('shop-grid');
  if (!mount || !window.SML_SHOP || !Array.isArray(window.SML_SHOP.products)) return;
  ...
  var html = window.SML_SHOP.products.map(function (p) {
