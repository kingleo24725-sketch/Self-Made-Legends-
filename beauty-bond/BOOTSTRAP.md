...
3. Confirm the **Come Up** side still carries the mirror-image webhook ownership gate
   described in §3.2. It was added there before this extraction; verify it survived,
   because Beauty Bond's first live charge depends on it.
